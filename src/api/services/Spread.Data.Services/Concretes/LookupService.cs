...
internal class LookupService : ILookupService
{
    ...
    public Task<bool> EditLookUp(Guid id, EditLookupRequestDto data, CancellationToken cancellationToken)
    {
        return mediator.Send(new EditLookupRequest(id,data), cancellationToken);
    }
